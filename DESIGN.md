...
가림막(`--scrim`) 위, 위에서 84px, 폭 `min(620px, 100vw - 32px)`, 20px 모서리, `--pop`, 등장 140ms. 641px 이상에서는 위에서 64px, `min(920px, 100vw - 48px)` × `min(720px, 100dvh - 112px)` **고정 크기**다 — 검색·회의 모아보기·오늘 신규가 모두 같은 크기라 칩을 바꿔도 창이 흔들리지 않는다. 결과 줄 54px.
